      ...
      <div className="max-w-md mx-auto px-4 py-6">
        ...
        {step === 4 && result && (
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-2xl shadow-sm p-6">
              <p className="font-semibold text-navy-900 mb-4 text-sm">Adicionar à agenda</p>
              <div className="flex gap-3">
                <a
            ...
            {form.clientWhatsapp && (
              <div className="bg-white rounded-2xl shadow-sm p-6">
                <p className="font-semibold text-navy-900 mb-4 text-sm">Enviar lembrete via WhatsApp</p>
                <a
